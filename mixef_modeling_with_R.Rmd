...
We estimate an expected mean difference of [-51.9, -29.5]. Compare this to the 95% confidence interval returned by {emmeans} which uses the Kenward-Roger approximation. That CI is [-60.0, -19.7], which is much wider.
